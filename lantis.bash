...
L_LOCAL_HOST=$(echo $in | awk -F '[;]' '{print $6}')       #Remote Host[string]
L_LOCAL_PORT=$(echo $in | awk -F '[;]' '{print $7}')       #Remote Port[string]
L_LOCAL_USER=$(echo $in | awk -F '[;]' '{print $8}')       #Remote User[string]
...
REMOTE_FWDPORT=$(echo $in | awk -F '[;]' '{print $12}')     #Remote Port[int]
L_LOCAL_FWDHOST=$(echo $in | awk -F '[;]' '{print $13}')   #Local Host[string]
LOCAL_FWDPORT=$(echo $in | awk -F '[;]' '{print $14}')     #Local Port[int]
